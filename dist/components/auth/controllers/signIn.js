...
function signIn(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, helpers_1.asyncWrapper)(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                (0, response_1.handleResponse)({ res, status: 400, message: "Invalid credential" });
            const samePassword = (0, helpers_1.comparePassword)(password, user.password);
            if (!samePassword)
                (0, response_1.handleResponse)({ res, status: 400, message: "Invalid credential" });
            const token = (0, helpers_1.generateToken)({ data: { ref: user.id } });
